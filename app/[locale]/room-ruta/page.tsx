      ...
      <div className="container">
        ...
        <div className="flex gap-8 flex-col lg:flex-row">
          <div className="w-full lg:w-2/3 mx-auto">
            <PropertyGallery property_gallery={RutaGalleryLib} />
            ...
            <div className="py-10">
              ...
              <p>
                ...
                <h2 className="font-ExtraBold text-md">
                  <Markdown>
                    {Villa_DescriptionData.data[0].Room_Ruta_Des_subtitle2}
                  </Markdown>
                </h2>
                <Markdown>
            ...
            <div className="py-10">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2">
                {FeaturesData.data.Room_Ruta.slice(0, 6).map((item, index) => (
                  <div
                    key={index}
        ...
        <div className="container py-10 mb-24">
          ...
          <AvailabilityCalendar Accommodation_name="Room Ruta" />
        </div>
      </div>
    </section>
  );
