      ...
      <div className="container">
        ...
        <div className="flex gap-8 flex-col lg:flex-row">
          <div className="w-full lg:w-2/3 mx-auto">
            <PropertyGallery property_gallery={LotaGalleryLib} />
            ...
            <div className="py-10">
              ...
              <p>
                ...
                <h2 className="font-ExtraBold text-md">
                  <Markdown>
                    {Villa_DescriptionData.data[0].Room_Lota_Des_subtitle2}
                  </Markdown>
                </h2>
                <Markdown>
            ...
            <div className="py-10">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2">
                {FeaturesData.data.Room_Lota.slice(0, 6).map((item, index) => (
                  <div
                    key={index}
        ...
        <div className="container py-10 mb-24">
          ...
          <AvailabilityCalendar Accommodation_name="Room Lota" />
        </div>
      </div>
    </section>
  );
