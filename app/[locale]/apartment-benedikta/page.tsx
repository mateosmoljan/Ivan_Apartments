...
import PriceTable_Benedikta from "@/components/PriceTable/PriceTable_Benedikta";
      ...
      <div className="container">
        ...
        <div className="flex gap-8 flex-col lg:flex-row">
          <div className="w-full lg:w-2/3 mx-auto">
            <PropertyGallery property_gallery={BenediktaGalleryLib} />
            ...
            <div className="py-10">
              ...
              <p>
                <Markdown>
                  {Villa_DescriptionData.data[0].Apartment_Benedikt_Des_des}
                </Markdown>
              </p>
              <p>
                <br />
                ...
                <Markdown>
                  {Villa_DescriptionData.data[0].Apartment_Benedikt_Des_des2}
                </Markdown>
                <br />
                <br />
                ...
                <Markdown>
                  {Villa_DescriptionData.data[0].Apartment_Benedikt_Des_des3}
                </Markdown>
              </p>
            </div>
            <hr />
            <div className="py-10">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2">
                {FeaturesData.data.Apartment_Benedikta.slice(0, 6).map(
                  (item, index) => (
                    <div
                      key={index}
