...
const rows = [
  createData("15.01. - 15.03.", 55, 2, 1),
  createData("15.03. - 01.05.", 62, 2, 1),
  createData("01.05. - 15.06.", 70, 2, 1),
  createData("15.06. - 15.09.", 75, 2, 1),
  createData("15.09. - 01.11.", 70, 2, 1),
  createData("01.11. - 01.12.", 62, 2, 1),
  createData("01.12. - 15.01.", 75, 2, 1),
];
