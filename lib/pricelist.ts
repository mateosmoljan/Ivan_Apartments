...
const createTitle = (title: string, subtitle: string): TitleData => {
  return {
    title,
    subtitle,
  };
...
export const TitleDataEn: DataObject = {
  data: [createTitle(enData.Pricelist.title, enData.Pricelist.subtitle)],
};
...
export const TitleDataHR: DataObject = {
  data: [createTitle(hrData.Pricelist.title, hrData.Pricelist.subtitle)],
};
